...
function R$1(a, b2, e2, d2, c2) {
  ...
  if (h2)
    return h2 = a, c2 = c2(h2), a = "" === d2 ? "." + Q$1(h2, 0) : d2, I$2(c2) ? (e2 = "", null != a && (e2 = a.replace(P$2, "$&/") + "/"), R$1(c2, b2, e2, "", function(a2) {
      return a2;
 ...
 * LICENSE file in the root directory of this source tree.
 */
var f$1 = reactExports, k = Symbol.for("react.element"), l$3 = Symbol.for("react.fragment"), m$2 = Object.prototype.hasOwnProperty, n$1 = f$1.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, p$2 = { key: true, ref: true, __self: true, __source: true };
...
function ke(a, b2) {
  if (ie$1)
    return "compositionend" === a || !ae && ge(a, b2) ? (a = nd(), md = ld = kd = null, ie$1 = false, a) : null;
  switch (a) {
    case "paste":
      return null;
    case "keypress":
  ...
  Jb(function() {
    ...
    if (0 === (b2 & 7)) {
      ...
      if (ae)
        ...
        ie$1 ? ge(a, c2) && (ba = "onCompositionEnd") : "keydown" === a && 229 === c2.keyCode && (ba = "onCompositionStart");
      ba && (de && "ko" !== c2.locale && (ie$1 || "onCompositionStart" !== ba ? "onCompositionEnd" === ba && ie$1 && ($a = nd()) : (kd = e3, ld = "value" in kd ? kd.value : kd.textContent, ie$1 = true)), xa = oe$1(d3, ba), 0 < xa.length && (ba = new Ld(ba, a, null, c2, e3), g3.push({ event: ba, listeners: xa }), $a ? ba.data = $a : ($a = he(c2), null !== $a && (ba.data = $a))));
...
const App$1 = "";
const apiUrl = "https://drab-lime-chinchilla-shoe.cyclic.app/api/transactions";
...
const Achievements = ({ totalAmount }) => {
  let studentsHelped = 8;
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:items-center sm:flex-row md:flex-col justify-start sm:space-x-4 md:space-x-0 space-y-4 sm:space-y-0 md:space-y-4 md:w-[300px] w-full", children: [
    /* @__PURE__ */ jsxs("div", { className: "border border-blueDeep py-8 flex flex-col items-center rounded-md sm:w-1/2 md:w-full lg:w-full", children: [
      /* @__PURE__ */ jsx("span", { className: "text-2xl sm:text-4xl md:text-5xl lg:text-5xl font-semibold text-blueDeep", children: studentsHelped }),
      /* @__PURE__ */ jsx("span", { className: "text-center text-blueDeep text-lg pt-1", children: "Students helped" })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "border border-blueDeep py-8 flex flex-col items-center rounded-md sm:w-1/2 md:w-full lg:w-full", children: [
      /* @__PURE__ */ jsxs("span", { className: "text-2xl sm:text-4xl md:text-5xl xl:text-5xl lg:text-6xl font-semibold text-blueDeep", children: [
        "₦",
        Math.ceil(totalAmount)
      ] }),
      /* @__PURE__ */ jsx("span", { className: "text-center text-blueDeep text-lg pt-1", children: "Donated" })
    ] })
  ] });
};
/*! *****************************************************************************
...
var CircularProgressbar = function(_super) {
  ...
  CircularProgressbar2.prototype.render = function() {
    var _a = this.props, circleRatio = _a.circleRatio, className = _a.className, classes = _a.classes, counterClockwise = _a.counterClockwise, styles2 = _a.styles, strokeWidth = _a.strokeWidth, text = _a.text;
    var pathRadius = this.getPathRadius();
    var pathRatio = this.getPathRatio();
    return reactExports.createElement(
      "svg",
      { className: classes.root + " " + className, style: styles2.root, viewBox: "0 0 " + VIEWBOX_WIDTH + " " + VIEWBOX_HEIGHT, "data-test-id": "CircularProgressbar" },
      this.props.background ? reactExports.createElement("circle", { className: classes.background, style: styles2.background, cx: VIEWBOX_CENTER_X, cy: VIEWBOX_CENTER_Y, r: VIEWBOX_HEIGHT_HALF }) : null,
      reactExports.createElement(Path, { className: classes.trail, counterClockwise, dashRatio: circleRatio, pathRadius, strokeWidth, style: styles2.trail }),
      reactExports.createElement(Path, { className: classes.path, counterClockwise, dashRatio: pathRatio * circleRatio, pathRadius, strokeWidth, style: styles2.path }),
      text ? reactExports.createElement("text", { className: classes.text, style: styles2.text, x: VIEWBOX_CENTER_X, y: VIEWBOX_CENTER_Y }, text) : null
    );
  };
...
var d$2 = (t2, e2, n2) => e2 in t2 ? i(t2, e2, { enumerable: true, configurable: true, writable: true, value: n2 }) : t2[e2] = n2;
var r = (t2, e2, n2) => (d$2(t2, typeof e2 != "symbol" ? e2 + "" : e2, n2), n2);
let o$2 = class o {
  constructor() {
...
let s$1 = new o$2();
let l$2 = (e2, f2) => {
  s$1.isServer ? reactExports.useEffect(e2, f2) : reactExports.useLayoutEffect(e2, f2);
};
function s(e2) {
...
function o$1() {
  let n2 = [], r2 = { addEventListener(e2, t2, s2, a) {
    return e2.addEventListener(t2, s2, a), r2.add(() => e2.removeEventListener(t2, s2, a));
...
function p() {
  let [e2] = reactExports.useState(o$1);
...
function l$1() {
  let [e2, f2] = reactExports.useState(s$1.isHandoffComplete);
  return e2 && s$1.isHandoffComplete === false && f2(false), reactExports.useEffect(() => {
    e2 !== true && f2(true);
  }, [e2]), reactExports.useEffect(() => s$1.handoff(), []), e2;
}
...
var j = ((a) => (a[a.None = 0] = "None", a[a.RenderStrategy = 1] = "RenderStrategy", a[a.Static = 2] = "Static", a))(j || {}), w = ((e2) => (e2[e2.Unmount = 0] = "Unmount", e2[e2.Hidden = 1] = "Hidden", e2))(w || {});
function D$1({ ourProps: r2, theirProps: t2, slot: e2, defaultTag: a, features: s2, visible: n2 = true, name: l2 }) {
  let o3 = h(t2, r2);
  if (n2)
    return m(o3, e2, a, l2);
  let f2 = s2 != null ? s2 : 0;
  ...
  if (f2 & 1) {
    ...
    return u$1(i2 ? 0 : 1, { [0]() {
      ...
      return m({ ...u2, hidden: true, style: { display: "none" } }, e2, a, l2);
    } });
  }
  return m(o3, e2, a, l2);
}
function m(r2, t2 = {}, e$1, a) {
  var y2;
  let { as: s2 = e$1, children: n2, refName: l2 = "ref", ...o3 } = g(r2, ["unmount", "static"]), f2 = r2.ref !== void 0 ? { [l2]: r2.ref } : {}, i2 = typeof n2 == "function" ? n2(t2) : n2;
  ...
  if (s2 === reactExports.Fragment && Object.keys(P(o3)).length > 0) {
    if (!reactExports.isValidElement(i2) || Array.isArray(i2) && i2.length > 1)
      throw new Error(['Passing props on "Fragment"!', "", `The current component <${a} /> is rendering a "Fragment".`, "However we need to passthrough the following props:", Object.keys(o3).map((p2) => `  - ${p2}`).join(`
...
`)].join(`
`));
    let d2 = e((y2 = i2.props) == null ? void 0 : y2.className, o3.className), c2 = d2 ? { className: d2 } : {};
    return reactExports.cloneElement(i2, Object.assign({}, h(i2.props, P(g(o3, ["ref"]))), u2, f2, O(i2.ref, f2.ref), c2));
  }
  return reactExports.createElement(s2, Object.assign({}, g(o3, ["ref"]), s2 !== reactExports.Fragment && f2, s2 !== reactExports.Fragment && u2), i2);
}
function O(...r2) {
...
function c({ value: o3, children: r2 }) {
  return React.createElement(n.Provider, { value: o3 }, r2);
}
function f() {
...
function b(g2 = 0) {
  let [t2, l2] = reactExports.useState(g2), u2 = reactExports.useCallback((e2) => l2((a) => a | e2), [t2]), n2 = reactExports.useCallback((e2) => Boolean(t2 & e2), [t2]), o3 = reactExports.useCallback((e2) => l2((a) => a & ~e2), [l2]), s2 = reactExports.useCallback((e2) => l2((a) => a ^ e2), [l2]);
...
function F(t2, e2) {
  ...
  if (!t2)
    return n2.dispose;
  let { transitionDuration: m2, transitionDelay: o3 } = getComputedStyle(t2), [u2, p2] = [m2, o3].map((a) => {
    let [r2 = 0] = a.split(",").filter(Boolean).map((i2) => i2.includes("ms") ? parseFloat(i2) : parseFloat(i2) * 1e3).sort((i2, f2) => f2 - i2);
    return r2;
  }), l2 = u2 + p2;
  if (l2 !== 0) {
    n2.group((r2) => {
...
function y(t2, e2, n2, m2) {
  let o3 = n2 ? "enter" : "leave", u2 = o$1(), p2 = m2 !== void 0 ? l(m2) : () => {
  };
  o3 === "enter" && (t2.removeAttribute("hidden"), t2.style.display = "");
  let l$12 = u$1(o3, { enter: () => e2.enter, leave: () => e2.leave }), a = u$1(o3, { enter: () => e2.enterTo, leave: () => e2.leaveTo }), r2 = u$1(o3, { enter: () => e2.enterFrom, leave: () => e2.leaveFrom });
  return v(t2, ...e2.enter, ...e2.enterTo, ...e2.enterFrom, ...e2.leave, ...e2.leaveFrom, ...e2.leaveTo, ...e2.entered), d(t2, ...l$12, ...r2), u2.nextFrame(() => {
    v(t2, ...r2), d(t2, ...a), F(t2, () => (v(t2, ...l$12), d(t2, ...e2.entered), p2()));
  }), u2.dispose;
}
function D({ container: i2, direction: t2, classes: o3, onStart: s$12, onStop: u2 }) {
  let a = f(), c2 = p(), r2 = s(t2);
  l$2(() => {
    let e2 = o$1();
    c2.add(e2.dispose);
    let n2 = i2.current;
    if (n2 && r2.current !== "idle" && a.current)
      return e2.dispose(), s$12.current(r2.current), e2.add(y(n2, o3.current, r2.current === "enter", () => {
...
var Ee = ((r2) => (r2.Visible = "visible", r2.Hidden = "hidden", r2))(Ee || {});
function be() {
...
function ne(n2, t2) {
  let r2 = s(n2), o$12 = reactExports.useRef([]), y2 = f(), N2 = p(), p$12 = o2((s2, e2 = w.Hidden) => {
    let a = o$12.current.findIndex(({ el: i2 }) => i2 === s2);
    a !== -1 && (u$1(e2, { [w.Unmount]() {
      o$12.current.splice(a, 1);
    }, [w.Hidden]() {
      o$12.current[a].state = "hidden";
    } }), N2.microTask(() => {
      var i2;
      !_(o$12) && y2.current && ((i2 = r2.current) == null || i2.call(r2));
    }));
  }), x2 = o2((s2) => {
    let e2 = o$12.current.find(({ el: a }) => a === s2);
    return e2 ? e2.state !== "visible" && (e2.state = "visible") : o$12.current.push({ el: s2, state: "visible" }), () => p$12(s2, w.Unmount);
  }), m2 = reactExports.useRef([]), c2 = reactExports.useRef(Promise.resolve()), u2 = reactExports.useRef({ enter: [], leave: [], idle: [] }), h2 = o2((s2, e2, a) => {
    ...
    })]), e2 === "enter" ? c2.current = c2.current.then(() => t2 == null ? void 0 : t2.wait.current).then(() => a(e2)) : a(e2);
  }), v2 = o2((s2, e2, a) => {
  ...
  return reactExports.useMemo(() => ({ children: o$12, register: x2, unregister: p$12, onStart: h2, onStop: v2, wait: c2, chains: u2 }), [x2, p$12, o$12, h2, v2, u2, c2]);
}
function xe() {
}
...
let ye = "div", ie = j.RenderStrategy;
function Ne(n2, t2) {
  let { beforeEnter: r2, afterEnter: o$12, beforeLeave: y2, afterLeave: N2, enter: p2, enterFrom: x2, enterTo: m2, entered: c$1, leave: u2, leaveFrom: h2, leaveTo: v2, ...s$2 } = n2, e$1 = reactExports.useRef(null), a = y$1(e$1, t2), i2 = s$2.unmount ? w.Unmount : w.Hidden, { show: l2, appear: T2, initial: se2 } = be(), [g2, M2] = reactExports.useState(l2 ? "visible" : "hidden"), z2 = Se(), { register: F2, unregister: L2 } = z2, U2 = reactExports.useRef(null);
  reactExports.useEffect(() => F2(e$1), [F2, e$1]), reactExports.useEffect(() => {
    if (i2 === w.Hidden && e$1.current) {
      if (l2 && g2 !== "visible") {
        M2("visible");
        return;
      }
      return u$1(g2, { ["hidden"]: () => L2(e$1), ["visible"]: () => F2(e$1) });
    }
  }, [g2, e$1, F2, L2, l2, i2]);
  let j2 = s({ enter: S(p2), enterFrom: S(x2), enterTo: S(m2), entered: S(c$1), leave: S(u2), leaveFrom: S(h2), leaveTo: S(v2) }), w$12 = Re({ beforeEnter: r2, afterEnter: o$12, beforeLeave: y2, afterLeave: N2 }), k2 = l$1();
  reactExports.useEffect(() => {
    if (k2 && g2 === "visible" && e$1.current === null)
      throw new Error("Did you forget to passthrough the `ref` to the actual DOM node?");
  }, [e$1, g2, k2]);
  let G2 = se2 && !T2, ae2 = (() => !k2 || G2 || U2.current === l2 ? "idle" : l2 ? "enter" : "leave")(), H2 = b(0), le2 = o2((C2) => u$1(C2, { enter: () => {
    H2.addFlag(d$1.Opening), w$12.current.beforeEnter();
  }, leave: () => {
    H2.addFlag(d$1.Closing), w$12.current.beforeLeave();
  }, idle: () => {
  } })), ue2 = o2((C2) => u$1(C2, { enter: () => {
  ...
  D({ container: e$1, classes: j2, direction: ae2, onStart: s((C2) => {
    O2.onStart(e$1, C2, le2);
  }), onStop: s((C2) => {
    O2.onStop(e$1, C2, ue2), C2 === "leave" && !_(O2) && (M2("hidden"), L2(e$1));
  }) }), reactExports.useEffect(() => {
    G2 && (i2 === w.Hidden ? U2.current = null : U2.current = l2);
  }, [l2, G2, g2]);
  let B2 = s$2, Te2 = { ref: a };
  return T2 && l2 && s$1.isServer && (B2 = { ...B2, className: e(s$2.className, ...j2.current.enter, ...j2.current.enterFrom) }), React.createElement(I.Provider, { value: O2 }, React.createElement(c, { value: u$1(g2, { ["visible"]: d$1.Open, ["hidden"]: d$1.Closed }) | H2.flags }, D$1({ ourProps: Te2, theirProps: B2, defaultTag: ye, features: ie, visible: g2 === "visible", name: "Transition.Child" })));
}
function He(n2, t2) {
  ...
  let a = reactExports.useMemo(() => ({ show: r2, appear: o3, initial: v2 }), [r2, o3, v2]);
  reactExports.useEffect(() => {
    if (r2)
      u2("visible");
    else if (!_(h2))
  ...
  let i2 = { unmount: y2 };
  return React.createElement(I.Provider, { value: h2 }, React.createElement(A.Provider, { value: a }, D$1({ ourProps: { ...i2, as: reactExports.Fragment, children: React.createElement(oe, { ref: x2, ...i2, ...N2 }) }, theirProps: {}, defaultTag: reactExports.Fragment, features: ie, visible: c2 === "visible", name: "Transition" })));
}
function De(n2, t2) {
...
let q = L(He), oe = L(Ne), Fe = L(De), tt = Object.assign(q, { Child: Fe, Root: q });
const CircularProgressBar = ({
  ...
  const [displayPercentage, setDisplayPercentage] = reactExports.useState(0);
  reactExports.useEffect(() => {
    let startTime2;
    const animation = (currentTime) => {
      ...
      const timeElapsed = currentTime - startTime2;
  ...
  return /* @__PURE__ */ jsxs("div", { className: "relative", children: [
    ...
    /* @__PURE__ */ jsx(
      tt,
      {
        ...
        leaveTo: "opacity-0",
        children: /* @__PURE__ */ jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: /* @__PURE__ */ jsx("div", { className: `!${textColor} font-bold text-2xl` }) })
      }
    )
  ] });
};
function Progress({ goalAmount }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mt-12 md:mt-4 xl:mt-16 py-6 lg:py-12", children: [
    allTransactions ? "" : /* @__PURE__ */ jsx("span", { className: "text-sm text-blueDeep font-raleway font-light", children: "Please wait, may take a few seconds." }),
    /* @__PURE__ */ jsxs("div", { className: "w-full md:flex", children: [
      /* @__PURE__ */ jsx("div", { className: "md:w-1/2 ", children: /* @__PURE__ */ jsx(Achievements, { totalAmount: percentage * goalAmount / 100 }) }),
      /* @__PURE__ */ jsx("div", { className: "md:w-1/2 mt-12 md:mt-4 xl:mt-16 flex items-center justify-center", children: /* @__PURE__ */ jsx(CircularProgressBar, { percentage }) })
    ] })
  ] });
}
...
const Completionist = () => /* @__PURE__ */ jsx("span", { children: "You are good to go!" });
const renderer = ({ days, hours, minutes, seconds, completed }) => {
  if (completed) {
    return /* @__PURE__ */ jsx(Completionist, {});
  } else {
    const totalHours = days * 24 + hours;
    const paddedMinutes = String(minutes).padStart(2, "0");
    const paddedSeconds = String(seconds).padStart(2, "0");
    return /* @__PURE__ */ jsxs("span", { className: "text-4xl", children: [
      totalHours,
      ":",
      paddedMinutes,
      ":",
...
const startTime = /* @__PURE__ */ new Date("2023-04-11T00:00:00");
const fiveDaysFromNow = startTime.getTime() + 5 * 24 * 60 * 60 * 1e3;
const Timer = () => {
  return /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(Countdown$1, { date: fiveDaysFromNow, renderer }) });
};
function Navbar({ logo: logo2 }) {
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx("div", { className: "bg-gray-50 py-2.5 px-6 sm:px-12 lg:px-20", children: /* @__PURE__ */ jsxs("div", { className: "sm:flex items-center justify-between", children: [
    /* @__PURE__ */ jsx("div", { className: "flex items-center", children: /* @__PURE__ */ jsx("img", { src: logo2, alt: "", className: "w-14 my-auto mx-auto" }) }),
    /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsxs("div", { className: "border border-blueDeep py-2.5 px-4 rounded-lg text-center sm:text-start mt-2 sm", children: [
      /* @__PURE__ */ jsx("span", { className: "hidden md:block", children: "Time Left" }),
      /* @__PURE__ */ jsx(Timer, {})
    ] }) })
  ] }) }) });
}
const logo = "data:image/jpeg;base64,";
const targetSVG = "/assets/Boy-throwing-a-dart-179145aa.svg";
function Goals({}) {
  return /* @__PURE__ */ jsxs("div", { className: "", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:items-center sm:flex-row md:flex-row justify-start sm:space-x-4  space-y-4 sm:space-y-0 lg:space-y-0 md:space-x-4 md:w-full lg:w-full w-full mt-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "border border-blueDeep py-8 flex flex-col items-center rounded-md sm:w-1/2 md:w-1/2", children: [
        /* @__PURE__ */ jsx("span", { className: "text-2xl sm:text-4xl md:text-5xl lg:text-5xl font-semibold text-blueDeep", children: "44" }),
        /* @__PURE__ */ jsx("span", { className: "text-center text-blueDeep text-lg pt-1", children: "Students to be aided" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "border border-blueDeep py-8 flex flex-col items-center rounded-md sm:w-1/2 md:w-1/2", children: [
        /* @__PURE__ */ jsx("span", { className: "text-2xl sm:text-4xl md:text-5xl lg:text-5xl font-semibold text-blueDeep", children: "₦7,000,000" }),
        /* @__PURE__ */ jsx("span", { className: "text-center text-blueDeep text-lg pt-1", children: "in donations" })
      ] })
    ] })
  ] });
}
function App() {
  const goalAmount = 7e6;
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen 2xl:h-screen w-full overflow-hidden", children: [
    /* @__PURE__ */ jsx(Navbar, { logo }),
    /* @__PURE__ */ jsxs("div", { className: "w-full mx-auto xl:flex flex-row min-h-screen lg:bg-gray-50 ", children: [
      /* @__PURE__ */ jsxs("div", { className: " xl:w-1/2 p-6 sm:p-12 md:p-20 lg:w-4/5 lg:mx-auto bg-gray-50", children: [
        /* @__PURE__ */ jsx("div", { className: "text-5xl font-bold font-raleway mb-2 text-blueDeep mt-10 sm:mt-0", children: "IRespond" }),
        /* @__PURE__ */ jsxs("div", { className: "text-lg font-light text-gray-700 mb-2 space-y-3", children: [
          /* @__PURE__ */ jsx("span", { className: "text-blueDeep text-xl", children: "Together, we can do it." }),
          /* @__PURE__ */ jsx("br", {}),
          /* @__PURE__ */ jsx("p", { className: "text-centre sm:text-start", children: "The CUSC Donation Bank is an avenue through which we aim to see every student resume We have a goal of 7,000,000 naira in 5 days! With this sum of money, we can ensure that no student misses out on the opportunity to study because they lack funds." })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "md:w-[300px] lg:w-[380px] ", children: /* @__PURE__ */ jsx("a", { href: "https://flutterwave.com/store/custudentcouncil/aqrlcjwfji5i89", children: /* @__PURE__ */ jsx("button", { className: "py-4 w-full bg-blueDeep mt-6 rounded-lg text-xl font-normal text-white", children: "Donate Now!" }) }) }),
        /* @__PURE__ */ jsx(Progress, { goalAmount })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "xl:w-1/2 p-6 sm:p-12 md:p-20 lg:w-4/5 lg:mx-auto", children: /* @__PURE__ */ jsx(Goals, {}) })
    ] })
  ] });
}
const index = "";
