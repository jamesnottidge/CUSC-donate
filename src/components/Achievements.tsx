...
export const Achievements = ({ totalAmount }: Props) => {
  ...
  return (
    <div className="flex flex-col md:items-center sm:flex-row md:flex-col xl:flex-row justify-center sm:space-x-4 md:space-x-0 xl:space-x-4 space-y-4 sm:space-y-0 md:space-y-4 mx-auto lg:w-[320px] w-full">
